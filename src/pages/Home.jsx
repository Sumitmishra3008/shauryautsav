    ...
    <section className="relative h-[97vh] w-full overflow-hidden">
      ...
      <div className="relative h-full flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-7xl mx-auto">
          ...
          <h1 className="mb-6 text-5xl sm:text-6xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-yellow-500 ">
            Shauryotsava 2025
          </h1>
          ...
          <div className="mb-12 inline-block px-6 py-2 bg-white/10 backdrop-blur-sm rounded-full">
            <p className="text-lg sm:text-xl font-semibold text-green-700 tracking-widest">
              21 - 23 FEBRUARY 2025
            </p>
          </div>
