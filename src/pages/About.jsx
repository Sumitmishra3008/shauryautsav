    ...
    <>
      ...
      <div className="relative flex mt-20 ">
        ...
        <main className="flex flex-col ">
          ...
          {/* Section: Description */}
          <div className="mb-8">
            <h2 className="text-2xl text-white font-bold text-center mb-4">About Us</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
            ...
            <Card image="https://via.placeholder.com/150" designation="Team Lead" />
            <Card image="https://via.placeholder.com/150" designation="Coordinator" />
            <Card image="https://via.placeholder.com/150" designation="Manager" />
            <Card image="https://via.placeholder.com/150" designation="Member" />
          </div>
